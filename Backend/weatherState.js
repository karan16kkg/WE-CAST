...
const weather2 = express();

weather2.post("/", async (req, res) => {
    const  {latitude,longitude}  = req.body;

    try {
        const response = await fetch(
            `https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=a322d39c25aa93e12bfe3ff1a6c68891&units=metric`
        );
